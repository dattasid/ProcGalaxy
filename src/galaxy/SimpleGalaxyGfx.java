...
public class SimpleGalaxyGfx
{
    ...
    private static void generate(Args args)
    {
        ...
        final int W = args.imageSize, H = args.imageSize;
...
//            int y = rand.nextInt(armlen/10);
            ...
            // which arm it is in.
            double dTh = Math.PI * swirlyAngularSpread * r /armlen;
            dTh += arm * armdTheta;
            ...
            float hue = (float) (hueStart + x * hueAlongArm/armlen + Math.abs(y) * hueThickArm/armlen/armThickness/*+ rand.nextFloat() * .3f*/);
